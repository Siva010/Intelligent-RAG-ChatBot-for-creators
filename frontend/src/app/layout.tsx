            ...
            <div className="flex items-center justify-between h-20">
              <div className="flex items-center gap-2">
                <svg
                  ...
                  className="w-8 h-8 text-[#00B2FF] stroke-current stroke-[3]"
                >
                  <path d="M21 12C21 16.9706 16.9706 21 12 21C9.69494 21 7.59227 20.1334 6 18.7083L3 21L5.29168 18C3.86656 16.4077 3 14.3051 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" />
                </svg>
                <div>
